...
router.get("/admin/cashiers", async (_req, res): Promise<void> => {
...
router.post("/admin/cashiers/activate", async (req, res): Promise<void> => {
...
router.post("/admin/cashiers", async (req, res): Promise<void> => {
...
router.delete("/admin/cashiers/:id", async (req, res): Promise<void> => {
